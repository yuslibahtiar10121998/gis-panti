    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <input id="Latitude" name="latitude" placeholder="Latitude" value="<?= $profil->latitude ?>" class="form-control"  />
            </div>

            <div class="form-group">
                <label>Longitude</label>
                <input id="Longitude" name="longitude" placeholder="Longitude" value="<?= $profil->longitude ?>" class="form-control"  />
            </div>
